 ...
 * Location:    resources\views\permissions
 * Author:      EROL A'NIL
 * Created:     08/09/21
 * Description:
...
<x-app-layout>
    <x-slot name="header">
        <h2
            class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Delete Permission') }}
        </h2>
    </x-slot>
    <div class="py-12">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <dl class="grid grid-cols-6 gap-2">
                        ...
                        <dd class="col-span-5">{{ $permission->id }}</dd>
                        <dt class="col-span-1">Name</dt>
                        <dd class="col-span-5">{{ $permission->name }}</dd>
                        <dt class="col-span-1">Added</dt>
                        <dd class="col-span-5">{{ $permission->created_at }}</dd>
                        ...
                        <dd class="col-span-5">
                            <form action="{{ route('permissions.destroy',['permission'=>$permission]) }}"
                                ...
                                @csrf
                                @method('delete')
                                <a href="{{ route('permissions.index', ['permission'=>$permission]) }}"
