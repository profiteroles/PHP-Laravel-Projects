            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{route('users.store')}}" method="post">
                        ...
                        <div class="w-full py-3">
                            <label class=" text-gray-600 w-full" for="email">E-mail</label>
                        ...
                        <div class="w-full py-3">
                            <label class="text-md text-gray-600 w-full" for="password">Password</label>
                        ...
                        <div class="w-full py-3">
                            <label class="text-gray-600 w-full" for="password_confirmation">Confirm Password</label>
