                    ...
                    <div class="overflow-x-auto ">
                        <table class="table w-full border border-0 border-bottom border-gray-300">
                            ...
                            <tr>
                                ...
                                <th class="p-2 flex justify-between text-left" scope="col"><a
                            ...
                            @foreach($users as $key=>$user)
                                ...
                                @if($user->id == auth()->user()->id) bg-gray-100 text-blue-800 font-semibold hover:bg-blue-200 hover:text-black @endif">
